package com.taskscheduler.User.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.taskscheduler.User.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.taskscheduler.User.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
